...
public class SpeakingIntroductionFragment extends Fragment {
    ...
    public SpeakingIntroductionFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_speaking_introduction, container, false);
    }
    ...
    private void checkPermissions() {
        if (ContextCompat.checkSelfPermission(requireContext(), Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(requireActivity(), new String[]{Manifest.permission.RECORD_AUDIO}, REQUEST_PERMISSIONS);
        }
    }
    ...
    // If you need to support runtime permission callbacks within the fragment
    @Override
